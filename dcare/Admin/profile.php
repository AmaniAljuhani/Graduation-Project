        ...
        <div class="content-wrapper" style="background-color: #fff;">
            ...
            <div class="content-header" style="margin-right:30px;">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="main-title">الملف الشخصي لمدير النظام</h1>
                        </div>
                        <!-- /.col -->
                    </div>
                    <!-- /.row -->
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <p class="text-muted text-center">مدير النظام</p>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
			    <strong><i class="fa fa-user mr-1"></i> اسم المدير</strong>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="settings">
                    <form class="form-horizontal" name="form" method="POST" action="../php/admin/profile.php">
                    <?php
                    ...
                    <div class="form-group">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="email" name="email" value="<?php echo $_SESSION['email'] ?>" class="form-control" id="inputName2" placeholder="البريد الإلكتروني">
                        </div>
                      </div>	
					  <div class="form-group">
